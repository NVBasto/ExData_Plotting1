...
with(hpc_filtered,lines(DateTime,as.numeric(as.character(Sub_metering_1))))
with(hpc_filtered,lines(DateTime,as.numeric(as.character(Sub_metering_2)),col="red"))
with(hpc_filtered,lines(DateTime,as.numeric(as.character(Sub_metering_3)),col="blue"))
